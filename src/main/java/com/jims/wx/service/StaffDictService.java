...
//            staffDict.setPassword(ed.enScript(vo.getPassword()));
    ...
    @GET
    @Path("find-by-info")
    public StaffDict findByLoginName(@QueryParam("hospitalId")String hospitalId,@QueryParam("loginName")String loginName,@QueryParam("password")String password){
        return staffDictFacade.findByLogin(loginName,password,hospitalId);
    }
