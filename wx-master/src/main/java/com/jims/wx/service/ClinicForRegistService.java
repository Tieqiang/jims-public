...
public class ClinicForRegistService {
    ...
    @Inject
    public ClinicForRegistService(ClinicForRegistFacade clinicIndexFacade) {
    ...
    public List<ClinicForRegist> listAll() {
        return clinicForRegistFacade.findAll(ClinicForRegist.class);
    }

    @POST
    @Path("save")
    public Response saveRequestMsg(List<ClinicForRegist> updateList) {
        try {
            List<ClinicForRegist> newUpdateDict = new ArrayList<>();
            if (updateList != null) {
                newUpdateDict = clinicForRegistFacade.save(updateList);
            }
