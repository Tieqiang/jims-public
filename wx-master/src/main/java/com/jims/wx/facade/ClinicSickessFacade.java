...
public class ClinicSickessFacade extends BaseFacade {
    ...
    public List<ClinicSickness> findByIds(List<String> list) {
        String ids="";
//        select * from clinic_sickness  where id in  ('40288622549941280154994e58700000','12312312')
//        '40288622549941280154994e58700000','12312312',
        for(String id:list){
            ids=ids+"'"+id+"'"+",";
        }
...
//         from ClinicSickness where id in  ("40288622549941280154994e58700000","12312312")
